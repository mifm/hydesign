...
from hydesign.finance.finance_P2X import finance_P2X_pp
...
class hpp_model(hpp_base):
    ...
    def __init__(
        ...
        **kwargs
        ...
        Ptg_cost = ptg_cost_pp(electrolyzer_capex_cost = sim_pars['electrolyzer_capex_cost'],
        ...
        ptg_cost_comp = ComponentWrapper([('ptg_MW',), 
                                          ('HSS_kg',), 
                                          ('m_H2_offtake_t', {'shape': [life_intervals]}), 
                                          ],
                                         [('CAPEX_ptg', ),
...
if __name__ == '__main__':
    ...
    start = time.time()
            # Wind plant design
    inputs=dict(clearance=clearance, sp=sp, p_rated=p_rated, Nwt=Nwt, wind_MW_per_km2=wind_MW_per_km2,
           # PV plant design
