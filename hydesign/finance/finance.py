...
class finance_pp:
    ...
    def compute(self, hpp_t_with_deg, penalty_t, price_t_ext, CAPEX_w, CAPEX_s, CAPEX_b, CAPEX_el, 
                OPEX_w, OPEX_s, OPEX_b, OPEX_el, wind_WACC, solar_WACC, battery_WACC, tax_rate):
        """ Calculating the financial metrics of the hybrid power plant project.
        ...
        return CAPEX, OPEX, revenues_mean, NPV, IRR, NPV_over_CAPEX, LCOE, mean_AEP, penalty_lifetime, break_even_PPA_price
